			...
			<div class="col-md-6">
				...
				<div class="card shadow mb-4">
					...
					<div class="card-body border">
						<vue-dropzone ref="myVueDropzone" id="dropzone" @vdropzone-success="handleDropzone" :options="dropzoneOptions"></vue-dropzone>
					</div>
				</div>
			</div>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select v-model="item.option" class="form-control">
										<option v-for="(variant, index) in variants" :value="variant.id" :key="index">
											{{ variant.title }}
										</option>
									</select>
								</div>
